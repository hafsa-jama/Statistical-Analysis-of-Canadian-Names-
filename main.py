...
def main (argv):
 # if len(argv) < 9:
   # print("Usage : ./main.py -f1 <file input 1> -f2 <file input 2> -f3 <file input 3> -f4 <file input 4> -f5 <file input 5> -f6 <file input 6> -f7 <file input 7> -f8 <file input 8>")
    #sys.exit(2)
 ...
 # for opt, arg in opts:
  #  if opt == '-h': ## this is used as an instruction 
   #         print ( "Usage: ./.py -i <input file name> -n <name>" )
    #        sys.exit()
